...
const (
	meminfoCollectorName = "meminfo"
	memInfoSubsystem     = "memory"
)

func init() {
	Register(meminfoCollectorName, true, NewMeminfoCollector)
}

// meminfoCollector exports memory stats from /proc/meminfo.
...
func NewMeminfoCollector(cfg CollectorConfig) (Collector, error) {
	fs, err := procfs.NewFS(cfg.Paths.ProcPath)
	if err != nil {
