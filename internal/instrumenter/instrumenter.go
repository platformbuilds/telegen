...
// eBPF metrics and traces are exported through shared exporters instead of creating
// per-subsystem exporters.
...
//   - sharedTracesExporter: Collector-compatible shared traces exporter.
