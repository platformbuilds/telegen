...
package tpinjector // import "github.com/mirastacklabs-ai/telegen/internal/tracers/tpinjector"
...
//go:generate $BPF2GO -cc $BPF_CLANG -cflags $BPF_CFLAGS -target amd64,arm64 Bpf ../../../bpf/tpinjector/tpinjector.c -- -I../../../bpf
