...
func TestInstrumentationSelection(t *testing.T) {
	...
	assert.False(t, is.OpenWireEnabled())
	assert.False(t, is.STOMPEnabled())
	...
	is = NewInstrumentationSelection([]Instrumentation{InstrumentationOpenWire})
	assert.False(t, is.KafkaEnabled())
	assert.False(t, is.MQTTEnabled())
	assert.False(t, is.NATSEnabled())
	assert.False(t, is.AMQPEnabled())
	assert.True(t, is.OpenWireEnabled())
	assert.False(t, is.STOMPEnabled())
	assert.True(t, is.MQEnabled())

	is = NewInstrumentationSelection([]Instrumentation{InstrumentationSTOMP})
	assert.False(t, is.KafkaEnabled())
	assert.False(t, is.MQTTEnabled())
	assert.False(t, is.NATSEnabled())
	assert.False(t, is.AMQPEnabled())
	assert.False(t, is.OpenWireEnabled())
	assert.True(t, is.STOMPEnabled())
	assert.True(t, is.MQEnabled())
