...
func Fixture() *TracesQuery {
	...
	err := json.Unmarshal([]byte(`{"data":[{"traceID":"eae56fbbec9505c102e8aabfc6b5c481","spans":[{"traceID":"eae56fbbec9505c102e8aabfc`+
		...
		`:[{"key":"otel.scope.name","type":"string","value":"go.opentelemetry.io/obi"},{"key":"span.kind"`+
		...
		`artTime":1686641491452470,"duration":3322,"tags":[{"key":"otel.scope.name","type":"string","value":"go.opentelemetry.io/obi"`+
		...
		`otel.scope.name","type":"string","value":"go.opentelemetry.io/obi"},{"key":"span.kind","type":"s`+
